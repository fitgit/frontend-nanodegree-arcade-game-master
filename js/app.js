...
var Player = function(level){
    ...
    this.level=level;
    //console.log("new'ing player,level=" +this.level);
}
...
Player.prototype.setLevel=function(level){
    ...
    if (allEnemies.length ===3 && level === 1){
        var enemyMiddle2=new Enemy(2,15,50);//run on stone row2, 15pix/sec speed,delay of 25 pix/sec
        allEnemies.push(enemyMiddle2);
    } else if (allEnemies.length ===3 && level === 2){
        var enemyMiddle2=new Enemy(2,15,50);//run on stone row2, 15pix/sec, speeddelay of 50 pix/sec
        allEnemies.push(enemyMiddle2);
        var enemyTop2=new Enemy(1,10,25);//run on stone row1, 10pix/sec speed,delay of 25 pix/sec
